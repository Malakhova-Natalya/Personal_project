...
| [Анализ данных youtube* - финансы]( "Анализ данных youtube* - финансы") | Анализ и сравнение видеоканалов о финансах: Forbes (Forbes Russia), "Деньги не спят", "Это Осетинская*", Private Talks. Использование собтсвенных метрик для анализа видео-контента и реакции на него аудитории. | python, pandas, matplotlib, seaborn, анализ данных, визуализация |
